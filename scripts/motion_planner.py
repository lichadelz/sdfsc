...
class MotionPlanner(object):
    def __init__(self, robot: Model, collision_checker_function, motion_cost_function):
        ...
        # self.objetive = ob.PathLengthOptimizationObjective(self.si)
        ...
        print(f'longest_valid_segment_length={self.longest_valid_segment_length}')
